        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 mt-[8rem]">
          ...
          >
            <div className="flex items-center">
              ...
              <h1 className="ml-3 text-3xl font-bold text-green-800">AyushmaanChain</h1>
            </div>

            <h2 className="text-2xl font-bold text-gray-800">Join the Healthcare Revolution</h2>
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <p className="ml-3 text-gray-600">Secure, tamper-proof medical records on blockchain</p>
              </div>
              ...
              <div className="flex items-start">
                ...
                <p className="ml-3 text-gray-600">NFT-based prescriptions for complete authenticity</p>
              </div>
              ...
              <div className="flex items-start">
                ...
                <p className="ml-3 text-gray-600">Merkle tree verification for drug authenticity</p>
              </div>
              ...
              <div className="flex items-start">
                ...
                <p className="ml-3 text-gray-600">Patient-controlled access to medical data</p>
              </div>
            </div>

            <div className="bg-green-100 p-4 rounded-lg border border-green-200">
              <h3 className="font-medium text-green-800">Already have an account?</h3>
              <button 
          ...
          >
            ...
            {account && (
              <div className="mb-4 p-3 bg-gray-100 rounded-lg">
                ...
                <p className="font-mono text-sm text-gray-800 truncate">{account}</p>
              </div>
            )}
